...
class DataLoader(object):
    ...
    def load_data(self, types, data_dir):
        ...
        for split in ['olid-train', 'olid-subset-diagnostic-tests', 'olid-test']:
            if split in types:
                sentences_file = os.path.join(data_dir, split+".csv")
                labels_file = os.path.join(data_dir, split+".csv")
                data[split] = {}
